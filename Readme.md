...
Para testear los servicios se utilizó Postman, enviando peticiones HTTP a los endpoints.
...
Evita operaciones incoherentes (seguirse a sí mismo, publicaciones vacías, etc.).
